...
const WalletConnectButton = () => {
  ...
  const [showProfileModa, setShowProfileModa] = React.useState<boolean>(false);
    ...
    if (!isAuthenticated) {
      return (
        <div
          ...
          className="flex w-full gap-2 items-center cursor-pointer dark:hover:bg-[#040413] px-3 py-2 hover:bg-[#b6bcc2]"
        >
          {!isLoading ? (
            <Icon
        ...
        return (
          ...
          >
            {(() => {
              ...
              return (
                <div className="flex relative gap-1 sm:gap-2 text-sm font-bold">
                  { showProfileModa && chain &&
                    <ProfileModal 
                      chain={chain}
                      setVisible={setShowProfileModa}
                      account={account}
                    /> 
                  }
                  <button
                    onClick={openChainModal}
                    className="founded-full flex-none p-[5px] flex items-center dark:border-black border-[2px] font-bold bg-[#DBE6FF] dark:bg-black rounded-full dark:text-[#5D5F68] hover:dark:text-white cursor-pointer"
                    type="button"
                  >
                  ...
                  >
                    ...
                    {account.displayBalance && (
                      <div className="pl-2 pr-3 truncate md:inline hidden dark:text-white text-[#23262F]">
                        ...
                        <span className="text-[#45B26B]">{ account.balanceSymbol }</span>
                      </div>
                    )}
                  </button>
                </div>
