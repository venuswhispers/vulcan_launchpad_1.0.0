...
const Stepper = ({step}: IProps) => {
  ...
  return (
    <ul className="relative flex flex-col xs:flex-row-reverse gap-2 mb-8">
      <li className="pr-2">
      ...
      <div className="flex grow gap-2 flex-col xs:flex-row">
        <li className="flex flex-col-reverse xs:flex-row xs:items-center gap-x-2 gap-2 shrink basis-0 flex-1 group">
          <div className="min-w-7 min-h-7 inline-flex items-center text-xs align-middle grow xs:grow-0">
        ...
        <li className="flex flex-col-reverse xs:flex-row xs:items-center gap-2 shrink basis-0 flex-1 group">
          <div className="min-w-7 min-h-7 inline-flex items-center text-xs align-middle grow xs:grow-0">
