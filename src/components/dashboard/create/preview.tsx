...
const Preview = () => {
  ...
  return (
    <div className="bg-[#F0F8FF] dark:bg-[#020111] rounded-2xl md:w-full w1200:max-w-[350px] px-5 py-7 flex-none">
      <h3 className="font-bold">Preview</h3>
      <div className="mt-5 mb-5 aspect-square flex justify-center items-center">
        {!preview ? (
          <Image
            src={"/images/logo.svg"}
            width={0}
      ...
      <div className="w-full mb-2">
        ...
        {ReactPlayer.canPlay(youtubeLink) ? (
          ...
          <div className="w-full aspect-video animate-pulse rounded-xl bg-white dark:bg-[#1d1b3965]"></div>
        )}
      </div>

      {title ? (
        <div className="flex h-12 justify-between items-center border-b border-[#E6E8EC] dark:border-[#ededee1a]">
          <h2 className="text-[15px] font-bold text-[#23262F] dark:text-[#B4B4B7] max-w-[150px] truncate">
            {title}
          </h2>
      ...
      {description && description !== "<p><br></p>" ? (
        <div
          className={`flex gap-4 ${
            !collapseDescription ? "min-h-12" : "h-12"
          } flex-col gap-3 pt-3 border-b border-[#E6E8EC] dark:border-[#ededee1a] pr-1`}
        >
        ...
        <div className="flex h-12 gap-4 justify-between items-center border-b border-[#E6E8EC] dark:border-[#ededee1a]">
          ...
          <div className="flex gap-1 items-center">
            ...
            <div className="text-[15px] flex gap-1 font-bold dark:text-[#B4B4B7] text-[#101010]">
              <h2 className="max-w-[100px] truncate">{hardCap}</h2>
              ETH
            </div>
          </div>
        </div>
      ...
      {softCap ? (
        <div className="flex h-12 gap-4 justify-between items-center border-b border-[#E6E8EC] dark:border-[#ededee1a]">
          ...
          <div className="flex gap-1 items-center">
            <Image src={"/images/eth.svg"} width={20} alt="" height={20} />
            <div className="text-[15px] flex gap-1 font-bold dark:text-[#B4B4B7] text-[#101010]">
              <h2 className="max-w-[100px] truncate">{softCap}</h2>
              ETH
            </div>
          </div>
        </div>
      ...
      {youtubeLink ? (
        <div className="flex h-12 justify-between items-center border-b border-[#E6E8EC] dark:border-[#ededee1a]">
          <h2 className="text-[15px] grow text-[#6F6F6F] dark:text-[#66666E]">
            Link
          </h2>
          <h2 className="text-[15px] truncate max-w-[150px] sm:max-w-[200px] text-nowrap font-bold dark:text-[#B4B4B7] text-[#101010]">
            {youtubeLink}
          </h2>
        </div>
      ) : (
